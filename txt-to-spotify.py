...
# Helper function to automatically set the right encoding
...
# Load list of songs from file and get the default encoding of the system
with open(filename, 'r', encoding=detect_encoding(filename)) as f:
    songs = f.readlines()
